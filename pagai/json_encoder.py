...
class MyJSONEncoder(flask.json.JSONEncoder):
    ...
    - SQLALchemy parses DB "number" objects to decimal.Decimal so we convert them to floats
    - SQLAlchemy parses DB "date" objects to datetime.date so we convert them to strings
    """
